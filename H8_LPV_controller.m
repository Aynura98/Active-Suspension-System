...
V1=([(Ag1*X+Bg1*Y1)+(Ag1*X+Bg1*Y1)'        Eg1            (Cg1*X+Dg1*Y1)';
                Eg1'             -gamma*eye(nw)        Fg1';
             (Cg1*X+Dg1*Y1)               Fg1      -gamma*eye(nz)]<=0);
V2=([(Ag2*X+Bg2*Y2)+(Ag2*X+Bg2*Y2)'        Eg2            (Cg2*X+Dg2*Y2)';
                Eg2'             -gamma*eye(nw)        Fg2';
             (Cg2*X+Dg2*Y2)               Fg2     -gamma*eye(nz)]<=0);
V3=(X>=0);
V4=(gamma>=0);
...
K1=double(Y1)*inv(double(X));
K2=double(Y1)*inv(double(X));
